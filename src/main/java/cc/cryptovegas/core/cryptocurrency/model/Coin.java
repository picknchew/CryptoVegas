package cc.cryptovegas.core.cryptocurrency.model;
...
public final class Coin implements Monetary, Comparable<Coin>, Serializable {
    ...
    public Coin multiply(BigDecimal decimal) {
        return new Coin(decimal.multiply(new BigDecimal(value)).longValue());
    }
